...
if (isset($_POST['register'])) {
    ...
    // Insert the data into the database
        ...
        $queryCreate = "INSERT INTO admin (`Full Name`, `EmailAddress`, `Password`) VALUES ('$fullName', '$email', '$password')";
        $sqlCreate = mysqli_query($connection, $queryCreate);

        if ($sqlCreate) {
            echo '<script>window.location.href = "/JOAN-BSIS3A/AdLog.php"</script>';
        } else {
...
<div class="container">
    ...
    <form method="POST" action="">
        ...
        <p>Already have an account? <a href="AdLog.php">Log in</a></p>
